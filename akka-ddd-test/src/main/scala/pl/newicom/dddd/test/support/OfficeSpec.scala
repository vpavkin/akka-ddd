 ...
 */
abstract class OfficeSpec[A <: BusinessEntity : BusinessEntityActorFactory : OfficeFactory](_system: Option[ActorSystem] = None, val shareAggregateRoot: Boolean = false)(implicit arClassTag: ClassTag[A])
