 ...
 */
abstract class OfficeSpec[A : BusinessEntityActorFactory : OfficeInfo](_system: Option[ActorSystem] = None, val shareAggregateRoot: Boolean = false)(implicit arClassTag: ClassTag[A])
